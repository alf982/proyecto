...
@section('content')
    <div class="page-header fade-up">
        <h1 class="page-title"><i class="fa-solid fa-shield-halved"
                style="color:var(--accent);margin-right:10px;"></i>Historial de Auditoría</h1>
    ...
    <div class="card fade-up" style="margin-bottom:20px;">
        <div class="card-body" style="padding:16px 22px;">
            <form method="GET"
                style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:12px;align-items:end;">
                ...
                <div style="display:flex;gap:8px;">
                    <button type="submit" class="btn btn-primary" style="flex:1;"><i class="fa-solid fa-filter"></i>
                        Filtrar</button>
                    <a href="{{ route('admin.auditoria.index') }}" class="btn btn-outline"><i
